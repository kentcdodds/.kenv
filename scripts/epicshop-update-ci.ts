// Name: EpicShop Update CI
// Description: Update the EpicShop workshop app in all the epic web workshop repos (CI version)
// Author: Kent C. Dodds
// Twitter: @kentcdodds
...
async function main() {
  ...
  // In CI environment, automatically proceed without user confirmation
  if (sortedWorkshopDirs.length > 30) {
    console.log(
      `🚨  Found ${sortedWorkshopDirs.length} workshop directories. Proceeding automatically in CI mode.`,
    )
  }
